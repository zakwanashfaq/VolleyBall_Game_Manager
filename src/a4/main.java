...
public class main {
    public static void main(String[] args) {
        // initializing league with three divisions
        VolleyBall league = new VolleyBall("Division 1", "Division 2", "Division 3");

        // getting the 1st initiated division and holding it as division1
        division division1  = league.getDivision1();
        ...
        // getting the 2nd initiated division and holding it as division 2 to show what happens if points are the same
        division division2  = league.getDivision2();
        ...
        //  getting the 3rd initiated division and holding it as division3 to show what happens in a live match
        // where a set is played until a team scores 21 points
        division division3 = league.getDivision3();
        ...
        System.out.println("          Also wins the entire Division. (If Draw Newfoundland Wins \n" +
                           "          because of higher point difference)");
