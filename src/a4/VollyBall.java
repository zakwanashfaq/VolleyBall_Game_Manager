...
//        match1.addMatch("Zakwan",15, "Zian", 0); // t1 won
        ...
        division1.addMatch("Zakwan",15, "Zian", 25);
        division1.addMatch("Zakwan",15, "Zian", 25);
        division1.addMatch("Ashfaq",35, "Zian", 25);
        division1.addMatch("Man",115, "Zian", 25);
        division1.addMatch("Zakwan",35, "Zian", 55);
//        division1.addMatch("Zakwan",15, "Zian", 25); // t2 won
